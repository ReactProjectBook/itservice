...
const initialState = {
    works: { data: null, isLoading: false, isRejected: false },
    work: { data: null, isLoading: false, isRejected: false },
    workDelete: { success: false, isLoading: false, isRejected: false },
    workSave: { data: null, isLoading: false, isRejected: false },
}
...
export default (state = initialState, action) => {
    switch (action.type) {
        ...
        //เก็บ state การดึงข้อมูลรายการแจ้งซ่อม id ที่ส่งไป
        ...
        //เก็บ state การลบข้อมูลรายการแจ้งซ่อม
        ...
        case 'SET_WORK_NEW':   //เตรียมสร้างข้อมูลใหม่
